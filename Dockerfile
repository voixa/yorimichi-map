...
# Copy static assets
COPY index.html lp.html about.html offline.html og.svg style.css app.js courses.js photos.js manifest.json sw.js sitemap.xml robots.txt /usr/share/nginx/html/
