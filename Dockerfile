...
# Copy static assets
COPY index.html lp.html about.html privacy.html offline.html profile.html og.svg og.png style.css app.js courses.js photos.js manifest.json sw.js sitemap.xml robots.txt /usr/share/nginx/html/
